...
//   Loader2
// } from "lucide-react";
// import { collection, getDocs, doc, updateDoc, where, query, DocumentData } from 'firebase/firestore';
...
//   // Send real acceptance email using your backend API
//   const sendRealAcceptanceEmail = async (applicationId: string) => {
//     try {
...
//           course: application.course // Added course to the email data
//         }),
//       });
...
//       // If accepted, send real email notification
//       if (newStatus === 'accepted') {
//         await sendRealAcceptanceEmail(applicationId);
//       }
...
//                                     {application.resumeFile || "Resume.pdf"}
//                                   </span>
//                                 </div>
...
//   const handleFileDownload = async (applicationId: string, fileName: string, fileType: string) => {
//     if (!fileName) {
//       alert('No file available for download');
//       return;
//     }
    
//     setDownloadingFile(applicationId);
    
//     try {
//       // Assuming files are stored in a "resumes" folder with the application ID as part of the path
//       // Adjust the path according to your Firebase Storage structure
//       const filePath = `resumes/${applicationId}/${fileName}`;
...
//     if (!fileName) return <FileText size={20} className="text-gray-500 mr-2" />;
    
//     const extension = fileName.split('.').pop()?.toLowerCase();
    
//     switch (extension) {
//       case 'pdf':
//         return <FileText size={20} className="text-red-500 mr-2" />;
//       case 'doc':
//       case 'docx':
//         return <FileText size={20} className="text-blue-500 mr-2" />;
//       case 'xlsx':
//       case 'xls':
//         return <FileText size={20} className="text-green-500 mr-2" />;
//       default:
//         return <FileText size={20} className="text-gray-500 mr-2" />;
//     }
//   };
...
//   const handleViewFile = async (applicationId: string, fileName: string) => {
//     if (!fileName) {
...
//                             {/* Resume */}
//                             <div>
//                               <h3 className="text-lg font-medium text-gray-900 mb-2">Resume/Documents</h3>
//                               <div className="bg-white p-4 rounded-lg border border-gray-200">
//                                 {application.resumeFile ? (
//                                   <div>
//                                     <div className="flex items-center justify-between mb-2">
//                                       <div className="flex items-center">
//                                         {getFileIcon(application.resumeFile)}
...
//                                         <button 
//                                           onClick={() => handleViewFile(application.id, application.resumeFile || '')}
//                                           disabled={downloadingFile === application.id}
...
//                                         <button 
//                                           onClick={() => handleFileDownload(application.id, application.resumeFile || '', '')}
//                                           disabled={downloadingFile === application.id}
//                                           className="text-emerald-600 hover:text-emerald-800 flex items-center"
//                                           title="Download file"
//                                         >
//                                           {downloadingFile === application.id ? 
...
//                                     {/* File type info and preview suggestion */}
//                                     <div className="text-xs text-gray-500 mt-2">
//                                       {application.resumeFile.toLowerCase().endsWith('.pdf') ? (
//                                         <p>PDF file - Click "View" to preview in browser</p>
//                                       ) : application.resumeFile.toLowerCase().match(/\.(docx|doc)$/) ? (
//                                         <p>Microsoft Word document - Download to view</p>
//                                       ) : application.resumeFile.toLowerCase().match(/\.(xlsx|xls)$/) ? (
//                                         <p>Microsoft Excel spreadsheet - Download to view</p>
//                                       ) : (
//                                         <p>Document file - Click "Download" to save</p>
//                                       )}
//                                     </div>
//                                   </div>
//                                 ) : (
//                                   <div className="text-gray-500 italic">No resume file attached</div>
//                                 )}
//                               </div>
//                             </div>
